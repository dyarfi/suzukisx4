...
<html lang="en">
  ...
  <body class="bg-article-page">
    <?php include 'header.php'; ?>
    <div class="container">
      
      <div class="back-to-article">
        <div class="article"><h3><a href="article.php">BACK TO ARTICLES</a></h3></div>
        <div class="article-bar-left"></div>
      </div>

      <div class="article-page">

        <h1>Di Senayan City Ada Yang Seru Lho! Apaan sih?</h1>
        <h4>Thursday, 21 July 2016   •   09.00 AM</h4>
