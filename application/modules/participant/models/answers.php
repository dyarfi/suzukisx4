...
class Answers Extends MY_Model {
	...
	public function getParticipantAnswer($participant_id = null){
	...
	public function getParticipantAnswerByType($participant_id = null, $type = 'fabric'){
	...
	public function getAllAnswer($type=''){
	...
	public function setAnswer($object=null){
